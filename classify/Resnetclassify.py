...
class TrainDataset(Dataset):
    def __init__(self):
        ...
        arr = np.array(train_npy[:], dtype=np.float32)
        arr.resize((30000, 1, 28, 28))
        ...
        self.train_label = torch.from_numpy(labelnp)
...
#实例化卷积层，resnet18[2,2,2,2] resnet34[3,4,6,3]，resnet50 Modelmore [3,4,6,3]
model = Model(BasicBlock,[2,2,2,2]).cuda()
